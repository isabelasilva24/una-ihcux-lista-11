...
| Campo       | Informação                                                                                       |
| ----------- | ------------------------------------------------------------------------------------------------ |
| Integrantes | Guilherme Ernani Oliveira Alonso<br>Ludmilla dos Santos S. Francisco<br>Isabela da Silva Freitas |
...
O **ReCiclo** permite que usuários doem e encontrem objetos de forma simples e rápida, conectando pessoas próximas e promovendo reutilização de materiais. O principal benefício é facilitar a doação, reduzir desperdício e gerar impacto positivo ao meio ambiente.
